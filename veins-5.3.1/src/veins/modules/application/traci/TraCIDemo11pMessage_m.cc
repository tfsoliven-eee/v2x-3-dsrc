//
// Generated file, do not edit! Created by opp_msgtool 6.2 from veins/modules/application/traci/TraCIDemo11pMessage.msg.
//
...
const char * TraCIDemo11pMessage::getExternalID() const
{
    return this->externalID.c_str();
}

void TraCIDemo11pMessage::setExternalID(const char * externalID)
{
    this->externalID = externalID;
}

const char * TraCIDemo11pMessage::getRoadID() const
{
    return this->roadID.c_str();
}

void TraCIDemo11pMessage::setRoadID(const char * roadID)
{
    this->roadID = roadID;
}

double TraCIDemo11pMessage::getSpeed() const
{
    return this->speed;
}

void TraCIDemo11pMessage::setSpeed(double speed)
{
    this->speed = speed;
}
