...
protected:
    ...
    // ===================================================================================================
    // for PEDESTRIANS
    std::map<std::string, cModule*> pedestrians; /**< all pedestrians managed by us */
    std::set<std::string> subscribedPedestriansList1;
    // END for PEDESTRIANS
    // ===================================================================================================
    ...
    // ===================================================================================================
    // for PEDESTRIANS
    void addPedestrianModule(std::string nodeId, std::string type, std::string name, std::string displayString, const Coord& position, std::string road_id = "", double speed = -1, Heading heading = Heading::nan, VehicleSignalSet signals = {VehicleSignal::undefined});
    // END for PEDESTRIANS
    // ===================================================================================================
    ...
    // ===================================================================================================
    // for PEDESTRIANS
    void subscribeToPedestrianVariables(std::string personId);
    void unsubscribeFromPedestrianVariables(std::string personId);
    void processPedestrianSubscription(std::string objectId, TraCIBuffer& buf);
    std::set<std::string> subscribedPedestrians;
