...
const char * VeinsInetSampleMessage::getExternalId() const
{
    return this->externalId.c_str();
}

void VeinsInetSampleMessage::setExternalId(const char * externalId)
{
    handleChange();
...
double VeinsInetSampleMessage::getSpeed() const
{
    return this->speed;
}

void VeinsInetSampleMessage::setSpeed(double speed)
{
    handleChange();
    this->speed = speed;
}

double VeinsInetSampleMessage::getSenderX() const
{
    return this->senderX;
}

void VeinsInetSampleMessage::setSenderX(double senderX)
{
    handleChange();
    this->senderX = senderX;
}

double VeinsInetSampleMessage::getSenderY() const
{
    return this->senderY;
}

void VeinsInetSampleMessage::setSenderY(double senderY)
{
    handleChange();
...
int VeinsInetSampleMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "externalId") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "roadId") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "speed") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "senderX") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "senderY") == 0) return baseIndex + 4;
