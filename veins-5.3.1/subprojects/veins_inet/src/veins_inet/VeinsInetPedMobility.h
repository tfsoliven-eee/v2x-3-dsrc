...
class VEINS_INET_API VeinsInetPedMobility : public inet::MobilityBase {
public:
    VeinsInetPedMobility();

    virtual ~VeinsInetPedMobility();
...
namespace veins {
class VEINS_INET_API VeinsInetPedMobilityAccess {
public:
    VeinsInetPedMobility* get(cModule* host)
    {
        VeinsInetPedMobility* m = FindModule<VeinsInetPedMobility*>::findSubModule(host);
        ASSERT(m);
        return m;
    };
};
